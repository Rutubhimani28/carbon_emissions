...
const ContactUs = () => {
  return (
    <div className='template-outer-theme-2 main pt-3 pb-2'>
      ...
      <p className="text-center fontFamily mb-3  py-3 fw-bold fs-5 wow animate__animated animate__fadeInUp animate__slow">
