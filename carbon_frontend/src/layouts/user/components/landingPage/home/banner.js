    ...
    return (
        <div>
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className='main py-5 my-2'>
                ...
                <Grid className='fs-5 wow animate__animated animate__fadeInRight animate__slow ' item sm={12} md={6}>We aim to seamlessly integrate Environmental, Social and Governance (ESG) considerations into your organization's CMO strategies by deeply understanding your needs. Our <Link to="/netZero-consulting" style={{ color: "#4edceb", textDecoration: 'none' }}>NetZero Consulting</Link> and user-friendly <Link to="/measure-ghg-emissions" style={{ color: "#4edceb", textDecoration: 'none' }}> NetZero Tool</Link> are designed to measure the carbon footprint generated by your marketing operations, activity by activity.</Grid>
