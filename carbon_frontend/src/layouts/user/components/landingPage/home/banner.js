    ...
    return (
        <div>
            ...
            {/* <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className='main py-5 my-2 '>
                ...
                <Grid className='fs-5 wow animate__animated animate__fadeInRight animate__slow ' item sm={12} md={6}>We aim to seamlessly integrate Environmental, Social and Governance (ESG) considerations into your organization's CMO strategies by deeply understanding your needs. Our <Link to="/esg-advisory-services" style={{ color: "#4edceb", textDecoration: 'none' }}>ESG advisory services</Link> and user-friendly <Link to="/measure-ghg-emissions" style={{ color: "#4edceb", textDecoration: 'none' }}> NetZero tool</Link> are designed to measure the carbon footprint generated by your marketing operations, activity by activity.</Grid>
            </Grid> */}
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className='main py-5 my-2'>
                <Grid className='fs-5 wow animate__animated animate__fadeInLeft animate__slow ' item sm={12} md={6} style={{ textAlign: 'justify' }}>At <strong>Sirat</strong>, we understand the needs and aspirations of organizations' Chief Marketing Officer (CMO) vertical. We recognize the necessity of aligning your activities with a NetZero framework. We create an action plan to achieve your short-, medium-, and long-term goals to reduce the CO<sub>2</sub> footprint generated from your marketing operations and  and enable a path to NetZero.</Grid>

                <Grid className='fs-5 wow animate__animated animate__fadeInRight animate__slow ' item sm={12} md={6}>We aim to seamlessly integrate Environmental, Social and Governance (ESG) considerations into your organization's CMO strategies by deeply understanding your needs. Our <Link to="/esg-advisory-services" style={{ color: "#4edceb", textDecoration: 'none' }}>NetZero Consulting</Link> and user-friendly <Link to="/measure-ghg-emissions" style={{ color: "#4edceb", textDecoration: 'none' }}> NetZero Tool</Link> are designed to measure the carbon footprint generated by your marketing operations, activity by activity.</Grid>
