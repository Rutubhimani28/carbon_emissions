...
const Exhibitions = () => {
    return (
        <div className='main py-5 mt-3'>
            <div>
                <Typography variant='h6' className='text-center fs-1 green pt-4 fontFamily fw-bold' >Exhibitions/ Congresses</Typography>
            </div>
            ...
            <p className=' fs-5'>Partnering with us enables you to address the ESG models effectively.</p>
            <p className=' fs-5'>Are you seeking a partner to assist you in setting up a strong ESG model to identify, optimise and reduce your carbon emissions generated during your exhibition/ congress? Kindly visit our<span style={{color: "#4edceb"}}> Sustainable Events </span>page and fill the details or alternatively share your details below and submit your request, we will promptly reconnect with you to explore the collaboration opportunities.</p>
        </div>
    )
}
