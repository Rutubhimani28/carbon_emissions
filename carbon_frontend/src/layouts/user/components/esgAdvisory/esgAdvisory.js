    ...
    return (
        <div>
            ...
            <div className='container'>
                <div>
                    <Typography variant='h6' className='text-center fs-3 green pt-4 fontFamily fw-bold' >ESG Advisory Services</Typography>
                    <p className='  py-3 pb-3 fontFamily '>We provide Environmental, Social, and Governance (ESG) advisory services to develop sustainable business strategies for the industries. Our objective is to foster collaboration and support within these industries to collectively meet the climate goals</p>
                </div>
                <div>
                    <Typography variant='h6' className=' fs-4 green pt-4 fontFamily fw-bold' >Industries</Typography>
                    <Grid container rowSpacing={2} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className='my-4 d-flex ms-1 justify-content-between'>
                ...
                <div>
                    <Typography variant='h6' className=' fs-3 green pt-4 fontFamily fw-bold' >Services</Typography>
                    <p className='  py-3 pb-3 fontFamily '>Our ESG advisory services assist industries in reducing their carbon footprint, creating a long-term business value.</p>
                    <img src={services} alt="services" className='mb-5 pb-5' />
                </div>
            </div>
        </div>
    )
