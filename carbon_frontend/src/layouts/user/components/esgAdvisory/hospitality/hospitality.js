...
const Hospitality = () => {
    return (
        <div className='main py-5 mt-3'>
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className='py-2 my-4  d-flex justify-content-center align-items-center ' >
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }} className='py-2  d-flex justify-content-center align-items-center ' >
                <Grid item xs={12} md={6} sx={{ order: { md: '1' } }} className='wow animate__animated animate__fadeInLeft animate__slow'>
                    <Box className=" p-3 ">
