...
const Organisations = () => {
    return (
        <div className='py-5 main'>
            ...
            <p>By adhering to the principles of a net-zero framework, organizations’ CMO verticals can chart a pathway towards a remarkable 50% reduction in their both direct and indirect greenhouse gas (GHG) emissions by the end of 2030. </p>
        </div>
    )
}
