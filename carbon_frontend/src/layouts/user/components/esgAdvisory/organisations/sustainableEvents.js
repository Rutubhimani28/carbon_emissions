    ...
    return (
        <div>
            ...
            <div className='main'>
                ...
                <div className='d-flex container justify-content-around py-5 mt-4 wow animate__animated animate__fadeInUp animate__slow'>
                    <div className='row'>
                        <div className='col-xl-6 col-md-6 col-sm-6 '>
                            <Box onClick={() => navigate("/event-venue")}>
                                <p
                                    className='text-center text-white pt-3 fontFamily fw-bold pb-2 rounded-3'
                                    style={{ cursor: "pointer", backgroundColor: "#4ABD43", padding: '10px' }}
                                >
                                    Event Venue
                                    <FaLocationDot />
                                </p>
                        ...
                        <div className='col-xl-6 col-md-6 col-sm-6'>
                            <Box onClick={() => navigate('/event-execution-agency')} className={ useMediaQuery(theme.breakpoints.up('md')) ? '' : 'mt-2'}
                            >
                                <p
                                    className="text-center  text-white fontFamily fw-bold  rounded-3"
                                    style={{ cursor: "pointer", backgroundColor: '#4ABD43', padding: '10px' }}
                                >
