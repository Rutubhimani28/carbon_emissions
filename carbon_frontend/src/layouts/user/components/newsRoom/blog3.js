        ...
        <div className='main mt-5 pb-5 position-relative'>
            <div className='container'>
                ...
                <Typography variant='h6' className='text-center fs-2 pt-4 fontFamily fw-bold px-3 wow animate__animated animate__fadeInUp animate__slow' >
                    <Link to="https://zeenews-india-com.cdn.ampproject.org/c/s/zeenews.india.com/companies/go-sustainable-unveils-a-net-zero-framework-to-reduce-carbon-footprint-in-marketing-operations-2715454.html/amp" target="_blank"  style={{ textDecoration: 'none', color: 'white' }}>Go Sustainable Unveils Net-Zero Framework To Reduce Carbon Footprint In Marketing Operations- Zee News</Link>
                </Typography>
            </div>
        </div>
    )
