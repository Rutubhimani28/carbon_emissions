    ...
    return (
        <div className='main my-5 position-relative'>
            <div className='container'>
                ...
                <p style={{ fontSize: "20px" }} className='wow animate__animated animate__fadeInUp animate__slow' >Not only do we assist you in connecting with the right vendors who can supply recyclable flex for your branding, stationery, and merchandise etc., all of which have a low carbon footprint and beyond and making your event a<span style={{ color: "#4edceb" }}> sustainable one.</span></p>
                <p style={{ fontSize: "20px" }} className='wow animate__animated animate__fadeInUp animate__slow mb-4'>Please send an email to us with your inquiries at <Link className='text-decoration-none' style={{ color: "#4edceb" }} to='mailto:askme@gosustainable.ai.'>askme@gosustainable.ai.</Link></p>
