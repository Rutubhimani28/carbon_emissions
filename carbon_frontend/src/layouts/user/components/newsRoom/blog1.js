    ...
    return (
        <div className='main my-5 position-relative'>
            <div className='container'>
                ...
                <Typography variant='h6' className='text-center fs-2 green pt-4 fontFamily fw-bold px-3' >Going Eco-Friendly with Go Sustainable: Aster CMI Hospital, Bangalore, hosts 2nd IAP-PEM Conference to make a green footprint</Typography>
                <ul className='p-5'>
                ...
                <p style={{ fontSize: "20px" }} ><strong>Pune, India, 18 Mar 2024: </strong>Go Sustainable, an early-stage start-up, has partnered with the organizing committee of the 2nd IAP-PEM Conference, a two-day conference hosted by Aster CMI Hospital, Bangalore, to support them in identifying, optimizing, and reporting the carbon emissions generated during the event.</p>
                <p style={{ fontSize: "20px" }} >Go Sustainable believes it’s time that organizations’ Chief Marketing Officer (CMO) verticals to start looking onto the carbon footprint generated during their marketing and communication activities and adopt sustainable measures to reduce the greenhouse gas (GHG) emissions, reporting them as part of their company-wide sustainability reports.</p>
                <p style={{ fontSize: "20px" }} >India holds the third position globally in terms of total GHG emissions produced, and collective efforts are needed to find ways to mitigate the carbon footprint generated from various activities.</p>
                <p style={{ fontSize: "20px" }} ><strong>Dr. Chetan Ginigeri, Organising Chairperson – 2nd IAP-PEM Conference, Program Director – Paediatrics, Aster Hospitals, Bangalore & Lead Consultant – Paediatrics & Paediatric Intensive Care, Aster CMI Hospital, Bangalore said: </strong>“Our goal was to champion sustainability in healthcare and inspire everyone by hosting an eco-friendly event. We’re glad to have partnered with Go Sustainable, whose expertise proved invaluable. They not only provided actionable advice to minimize our environmental impact but also measured and delivered a comprehensive report on the event’s sustainability efforts.”</p>
                <p style={{ fontSize: "20px" }} ><strong>Mr. Mohammed Shafeeq, Founder and CEO, Go Sustainable, said: </strong>“We are delighted to collaborate with Aster CMI Hospital in their initiative to reduce the carbon footprint generated from their conference. This marks a crucial step in raising awareness on adopting sustainable measures in the marketing operations. We look forward to strengthening our partnership with Aster CMI Hospital.”</p>
                <p style={{ fontSize: "20px" }} ><strong>About Go Sustainable </strong></p>
                <p style={{ fontSize: "20px" }} >At Go Sustainable, we enable the path to net-zero.</p>
                ...
                <p style={{ fontSize: "20px" }} ><strong>For media inquiries contact: </strong></p>
                <p style={{ fontSize: "20px" }} >Mohammed Shafeeq</p>
                <p style={{ fontSize: "20px" }} >Email: <Link className='text-decoration-none' style={{ color: "#4edceb" }} to='mailto:mohammed.shafeeq@gosustainable.ai'>mohammed.shafeeq@gosustainable.ai</Link></p>
                <p style={{ fontSize: "20px" }} ><strong>Follow us on social media </strong></p>
                <p ><Link className='text-decoration-none' style={{ color: "#4edceb" }} to='https://www.linkedin.com/company/gosustainable-cmo/'>LinkedIn </Link> <Link className='text-decoration-none' style={{ color: "#4edceb" }} to='https://twitter.com/shafeeqm'>Twitter</Link></p>
            </div>
