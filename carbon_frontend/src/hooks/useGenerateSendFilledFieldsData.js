...
const UseGenerateSendFilledFieldsData = () => {
    ...
    const total1 = Number(allProductionData?.totalEmission) + Number(allAirFreightData?.totalEmission) + Number(allFoodData?.totalEmission) + Number(allEnergyData?.totalEmission) + Number(allAirTravelData?.totalEmission) + Number(allDigitalContentData?.totalEmission) + Number(allLocalTranspotationData?.totalEmission) + Number(allHotelData?.totalEmission) + Number(allWasteData?.totalEmission)
    ...
    const total3 = Number(allPrAgencyData?.totalEmission) + Number(allHospitalityData?.totalEmission) + Number(allCommsData?.totalEmission);

    // digital campaign
    const allDigitalCampaignData = useSelector((state) => state?.totalDigitalCampaignDetails);
    const total4 = Number(allDigitalCampaignData?.totalEmission);
