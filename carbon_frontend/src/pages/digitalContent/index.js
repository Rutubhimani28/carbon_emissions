                                ...
                                <TableHead>
                                    {
                                        row.name === "Emails" &&
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Count</TableCell>
                                    ...
                                    }
                                    {
                                        row.name === "Laptop" &&
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>No.of Attendees</TableCell>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>No. Of Hours</TableCell>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Action</TableCell>
                                        </TableRow>
                                    ...
                                    }
                                    {
                                        row.name === "Attachment" &&
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>MB</TableCell>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Action</TableCell>
                                        </TableRow>
                                    }
                                </TableHead>
...
export default function CollapsibleTable() {
    ...
    const { data } = useSelector((state) => state?.digitalContentDetails)
