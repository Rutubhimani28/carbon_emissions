  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      AddData({
        type: 'toolForm',
        ...values,
        isDirtyData: formik?.dirty,
        isValidData: formik?.isValid,
        isSubmited: true,
      });
    },
  });
  ...
  return (
    <>
      <Container maxWidth="lg" className="text-white">
        <TiInfoLarge
          className="fs-3 bg-white text-dark rounded-circle mx-3 p-1"
          onClick={() => handleOpenInfo()}
          style={{ cursor: 'pointer', position: 'absolute', right: '4px' }}
        />
            ...
            >
              ...
              >
                ...
                <Grid item xs={12} sm={12}>
                  ...
                  >
                    <FormControlLabel value="add" control={<Radio />} label="New Activity" />
                    <FormControlLabel value="retrieve" control={<Radio />} label="Retrive Previous Activity" />
                  </RadioGroup>
                </Grid>
                      ...
                      <DateTimePicker
                        ...
                        onChange={(newValue) => {
                          formik.setFieldValue(
                            'dateTime',
                            newValue ? dayjs(newValue).format('YYYY-MM-DD HH:mm') : null
                          );
                          formik.setFieldTouched('dateTime', true);
                        }}
                        onOpen={() => {
                        ...
                        defaultValue={null}
                        className={`custom-dateTimePicker-field ${
                          formik.touched.dateTime && formik.errors.dateTime && ' custom-dateTimePicker-fieldError'
                        }`}
                        format="YYYY-MM-DD HH:mm"
                        ampm={false}
                      />
                ...
                <Grid item xs={12} sm={12}>
                  <p className="pt-2">
                    ...
                    <Link
                      style={{ color: '#ffffd9', textDecoration: 'none', fontSize: '14px' }}
        ...
        <Grid xs={3} md={6} spacing={2}>
          ...
          <Grid xl={3} md={6} sm={12}>
            <Box display={'flex'} flexWrap={'wrap'} justifyContent={'center'}>
              ...
              <Box
                onClick={() => isSubmited && navigate('/dashboard/pr-event')}
                className="organise m-2 p-2 h-25"
                style={{ borderRadius: '20px', cursor: 'pointer' }}
              >
                <img
              ...
              <Box
                onClick={() => isSubmited && navigate('/dashboard/campaign')}
                className="organise m-2 p-2 h-25"
                style={{ borderRadius: '20px', cursor: 'pointer' }}
              >
                <img
        ...
        >
          <Box sx={style}>
            ...
            <ul>
              <li>
                To obtain an accurate Carbon footprint generated from your activity, please input the data in the
                allotted fields
              </li>
              <li>
              ...
              <li>
                The summary page will give you how much Carbon footprint you generated per $ spent on your above
                activity.
              </li>
