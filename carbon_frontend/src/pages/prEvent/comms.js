          ...
          <Box mx={useMediaQuery(theme.breakpoints.up('lg')) && 15} display={'flex'} alignItems={'center'} flexDirection={'column'}>
            ...
            >
                ...
                <Box>
                  <div className='table-responsive'>
                    ...
                    <table className='table-custom-inpt-field'>
                      ...
                      <tr>
                        <td className='ps-2' width="100">Emails </td>
                        ...
                        <td className='ps-2 py-1'>
                          <TextField size='small' type="number" disabled name='emissionOne' value={values?.emissionOne} onChange={formik.handleChange} /></td>
                      </tr>
                    </table>
                  </div>
                </Box>
                  ...
                  <div className='table-responsive mt-4'>
                    <table className='table-custom-inpt-field'>
                      <tr>
                        ...
                        <th className='ps-3'>Final File Size (in Mb)</th>
                        <th className='ps-3'>Sending to Media File Size (No of Emails)</th>
                        <th className='ps-2'>Emissions</th>
                      </tr>
                      <tr>
                        <td className='ps-2' width="100">Video Byte</td>
                        ...
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='finalFileSizeOne' value={values?.finalFileSizeOne}
                            onChange={(e) => {
                              const emissionTwo = e.target.value === 0 ? 0 : Number(Number(e.target.value) * Number(values?.prFileSizeOne) * Number(values?.sendingToMediaOne) * Number(values?.efTwo)).toFixed(2);
                        ...
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='sendingToMediaOne' value={values?.sendingToMediaOne}
                            onChange={(e) => {
                              const emissionTwo = e.target.value === 0 ? 0 : Number(Number(e.target.value) * Number(values?.prFileSizeOne) * Number(values?.finalFileSizeOne) * Number(values?.efTwo)).toFixed(2);
                      ...
                      <tr>
                        ...
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='finalFileSizeTwo' value={values?.finalFileSizeTwo}
                            onChange={(e) => {
                              const emailEmissionThree = e.target.value === 0 ? 0 : Number((Number(e.target.value) * Number(values?.prFileSizeTwo) * Number(values?.sendingToMediaTwo) * Number(values?.efTwo)) / 1000).toFixed(2);
                        ...
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='sendingToMediaTwo' value={values?.sendingToMediaTwo}
                            onChange={(e) => {
                              const emailEmissionThree = e.target.value === 0 ? 0 : Number((Number(e.target.value) * Number(values?.prFileSizeTwo) * Number(values?.finalFileSizeTwo) * Number(values?.efTwo)) / 1000).toFixed(2);
                ...
                <Box>
                  <div className='table-responsive'>
                    ...
                    <table className='table-custom-inpt-field'>
                      <tr>
                        <th className='ps-2' />
                        <th className='ps-3'>Image Size (in Mb)</th>
                        <th className='ps-3'>Impressions</th>

                        <th className='ps-2'>Emissions</th>
                      </tr>
                      <tr>
                        <td className='ps-2 py-1' width="100">Image</td>
                        <td className='ps-3 py-1'>
                        ...
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='impressionsOne' value={values?.impressionsOne}
                            onChange={(e) => {
                              ...
                              formik.setFieldValue("emissionFour", (Number(e.target.value) * Number(values.imgSize) * Number(values.efOne)).toFixed(2));
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }} />
                        </td>
                ...
                <Box>
                  <div className='table-responsive my-4'>
                    <table className='table-custom-inpt-field'>
                      ...
                      <tr>
                        <td className='ps-2 py-1' width="100">Video</td>
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='videoSize' value={values?.videoSize}
                            onChange={(e) => {
                              ...
                              formik.setFieldValue("emissionFive", (Number(e.target.value) * Number(values?.impressionsTwo) * Number(values.videoMins) * Number(values.efTwo)).toFixed(2));
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }} />
                        </td>
                        ...
                        <td className='ps-3 py-1'>
                          <TextField size='small' type="number" name='impressionsTwo' value={values?.impressionsTwo}
                            onChange={(e) => {
                              ...
                              formik.setFieldValue("emissionFive", (Number(e.target.value) * Number(values.videoSize) * Number(values.videoMins) * Number(values.efTwo)).toFixed(2));
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }} />
                        </td>
                        <td className='ps-2 py-1'><TextField size='small' type="number" name='emissionFive' disabled value={values?.emissionFive} onChange={formik.handleChange} /></td>
                      </tr>
                    </table>
                  </div>
                </Box>
              ...
              <Grid item xs={12} sm={12} md={12} marginY={2}>
                <Typography color='white'>{`Total Comms Carbon Footprint = ${totalEmission} `}kgCO<sub>2</sub>e</Typography>
              </Grid>
            </Grid>
          </Box>
        </Card>
