...
const Hospitality = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const totalLunchEmission =
        (Number(emissionOne) || 0) +
        (Number(emissionTwo) || 0) +
        (Number(emissionThree) || 0) +
        (Number(emissionFour) || 0);
      ...
      const foodWasteEmission =
        (Number(foodWasteNonMeatEmission) || 0) +
        (Number(foodWasteMeatEmission) || 0) +
        (Number(foodWasteMixEmission) || 0) +
        (Number(fruitVegetablesEmission) || 0);
      const totalPlasticWasteEmissiom =
        (Number(bottleOneEmission) || 0) + (Number(bottleTwoEmission) || 0) + (Number(bottleThreeEmission) || 0);
      ...
      dispatch(
        prEventEmissionCatogorywise({
          categories: [
            { catgName: 'Food/Lunch', emission: totalLunchEmission },
            { catgName: 'Red Meat', emission: emissionThree },
            { catgName: 'Food-PetBottleWaste', emission: foodPlasticWasteEmission },
          ],
        })
      );
    },
    ...
    <div>
      <Container maxWidth>
        ...
        >
          ...
          >
            <IconDiv>
              <img src={hospitalityImg} alt="Transportation" width={100} className="tabImgWhite" />
            </IconDiv>
            <Grid container rowSpacing={3} columnSpacing={{ xs: 0, sm: 5, md: 4 }}>
                      ...
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              handleChangeFoodWaste(e, 'emissionTwo', e.target.value, 5.76);
                            }}
                            inputProps={{ style: { color: 'white' } }}
                          />
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              handleChangeFoodWaste(e, 'emissionThree', e.target.value, 23.55);
                            }}
                            inputProps={{ style: { color: 'white' } }}
                          />
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              handleChangeFoodWaste(e, 'emissionFour', e.target.value, 0.6);
                            }}
                            inputProps={{ style: { color: 'white' } }}
                          />
                        </td>
                      ...
                      <tr>
                          ...
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'foodWasteNonMeatEmission',
                                Number(0.74 * Number(e?.target?.value)).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                        ...
                        <td className="ps-2 py-1">
                          <TextField
                            ...
                            disabled
                            value={values?.foodWasteNonMeatEmission}
                            onChange={formik.handleChange}
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'foodWasteMeatEmission',
                                Number(0.76 * Number(e.target.value)).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                        ...
                        <td className="ps-2 py-1">
                          <TextField
                            ...
                            disabled
                            value={values?.foodWasteMeatEmission}
                            onChange={formik.handleChange}
                          />
                        </td>
                      </tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'foodWasteMixEmission',
                                Number(0.75 * Number(e.target.value)).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'fruitVegetablesEmission',
                                Number(0.31 * Number(e.target.value)).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                      ...
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'bottleOneEmission',
                                Number(Number(e.target.value) * 6.42 * 0.022).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                        ...
                        <td className="ps-2 py-1">
                          <TextField
                            ...
                            disabled
                            value={values?.bottleOneEmission}
                            onChange={formik.handleChange}
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'bottleTwoEmission',
                                Number(Number(e.target.value) * 13 * 0.022).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                        ...
                        <td className="ps-2 py-1">
                          <TextField
                            ...
                            disabled
                            value={values?.bottleTwoEmission}
                            onChange={formik.handleChange}
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="ps-3 py-1">
                          <TextField
                            ...
                            onChange={(e) => {
                              ...
                              formik.setFieldValue(
                                'bottleThreeEmission',
                                Number(Number(e.target.value) * 21.5 * 0.022).toFixed(2)
                              );
                              formik.handleSubmit();
                            }}
                            inputProps={{ style: { color: 'white' } }}
                        ...
                        <td className="ps-2 py-1">
                          <TextField
                            ...
                            disabled
                            value={values?.bottleThreeEmission}
                            onChange={formik.handleChange}
                          />
                        </td>
                      </tr>
              ...
              <Grid item xs={12} sm={12} md={12} marginY={2}>
                <Typography color="white">
                  {`Total Hospitality Carbon Footprint = ${totalEmission} `}kgCO<sub>2</sub>e
                </Typography>
              </Grid>
            </Grid>
          </Box>
