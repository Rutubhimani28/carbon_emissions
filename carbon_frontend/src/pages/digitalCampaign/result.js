            ...
            <Container maxWidth>
                <Card className='custom-inner-bg'>
                    <Box color='white' style={{ padding: "20px", display: "flex", justifyContent: "center", flexDirection: "column", alignItems: 'center' }}>
                        ...
                        <Typography className='text-center py-1 fw-bold mt-1 fs-5'>For every $ you spend you are generating {`${toolFormData.budget}`} kgCO2e (the {`${toolFormData.budget}`} value needs to be- total
                            emissions in kgCO2e divided by the budget)</Typography>
