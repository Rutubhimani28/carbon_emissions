...
const VirtualEvent = (props) => {
    ...
    const initialValues = {
        ...
        noOfpeopleEleven: '',
        efThirteen: 2.25,
        emissionThirteen: '',  // noOfMinutesEleven * noOfpeopleEleven * efThirteen
    };
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            const emissionThirteen = values?.noOfMinutesEleven === 0 || values?.noOfpeopleEleven === 0 ? 0 : Number(((Number(values?.noOfpeopleEleven) * Number(values?.noOfMinutesEleven) * values?.efThirteen) / 1000)).toFixed(2)
            ...
            const data = [
                ...
                {
                    name: '',
                    noOfMinutesEleven: values?.noOfMinutesEleven,
                    noOfpeopleEleven: values?.noOfpeopleEleven,
                    efThirteen: values?.efThirteen,
                    emissionThirteen: emissionThirteen > 0 ? emissionThirteen : ''
                }
            ];
    ...
    console.log("----- virtualEvent formik.values ", formik.values);
                    ...
                    <Box mx={useMediaQuery(theme.breakpoints.up('lg')) && 15} display={'flex'} alignItems={'center'} flexDirection={'column'}>
                        ...
                        <Grid container rowSpacing={3} columnSpacing={{ xs: 0, sm: 5, md: 4 }}>
                            <Grid item xs={12} sm={12} >
                                <Typography variant='h6' className='text-center text-white'>Video Conferencing</Typography>
                            </Grid>
                                        ...
                                        <table className='table-custom-inpt-field'>
                                            ...
                                            <tr>
                                                ...
                                                <td className='ps-2 py-1'><TextField size='small' type="number" name={'noOfEmails'} value={values?.noOfEmails}
                                                    onChange={(e) => {
                                                        formik.setFieldValue("noOfMinutesEleven", e.target.value);
