...
import { fetchWasteData } from '../../redux/slice/wasteSlice'
                                ...
                                <TableHead>
                                    {
                                        row.name === "Waste" &&
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Kgs</TableCell>
                                    ...
                                    }
                                    {
                                        row.name === "Water" &&
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Litres/ area m3*</TableCell>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Action</TableCell>
                                        </TableRow>
                                    ...
                                    }
                                    {
                                        ...
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>No. of PET bottles</TableCell>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Action</TableCell>
                                        </TableRow>
                                    }
                                    {
                                        row.name === "Branding" &&
                                        <TableRow>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Kg</TableCell>
                                            <TableCell className='fw-bolder text-muted fs-6 text-center'>Action</TableCell>
                                        </TableRow>
                                    }
                                </TableHead>
...
export default function CollapsibleTable() {
    ...
    const { data, isLoading } = useSelector((state) => state?.wasteDetails)
