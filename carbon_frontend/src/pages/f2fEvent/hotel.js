          ...
          <Box style={{ display: 'flex', justifyContent: 'center' }}>
            ...
            >
              ...
              >
                <Grid item xs={12} sm={4} md={5}>
                        ...
                        onChange={(event) => {
                          ...
                          if (event === null) {
                            ...
                            formik.setFieldValue(
                              'filteredCountries',
                              HotelData?.filter((item) => item?.geography === event.value)?.map((item) => ({
                                ...item,
                                value: item?.country,
                                label: item?.country,
                              })) || []
                    ...
                    <FormControl fullWidth>
                      ...
                      <Select
                        ...
                        onChange={(event) => {
                          ...
                          // reset fields
                          const selectedHotelTypeData = formik.values?.filteredCountries?.find(
                            (item) => item?.country === formik.values?.country.country
                          );
                          const hotellTypeEf =
                            event?.value === 4 || event?.value === 4.5
                              ? selectedHotelTypeData?.stars_four_fourPointHalf
                              : selectedHotelTypeData?.stars_five;
                          formik.setFieldValue('efOne', hotellTypeEf);
                          formik.handleSubmit();
                        }}
                      />
                  ...
                  <Grid mt={2} className="textborder">
                    ...
                    <FormControl fullWidth>
                      <TextField
                        ...
                        error={formik.touched.roomsOccupied && Boolean(formik.errors.roomsOccupied)}
                        helperText={formik.touched.roomsOccupied && formik.errors.roomsOccupied}
                        inputProps={{ style: { color: 'white' } }}
                      />
                      <FormHelperText error={formik.touched.roomsOccupied && Boolean(formik.errors.roomsOccupied)}>
                  ...
                  <Grid mt={2} className="textborder">
                    ...
                    <TextField
                      ...
                      error={formik.touched.emissionsOne && Boolean(formik.errors.emissionsOne)}
                      helperText={formik.touched.emissionsOne && formik.errors.emissionsOne}
                    />
                  </Grid>
                </Grid>
                {/* <Grid item xs={0} sm={2} /> */}
                ...
                <Grid item xs={12} sm={12} md={12} display={'flex'} justifyContent={'center'} mt={4}>
                ...
                <Grid item xs={12} sm={12} md={12} marginY={2} display={'flex'} justifyContent={'center'}>
                  <Typography color="white">
                    {`Total Hotel Carbon Footprint  = ${totalEmission} `}kgCO<sub>2</sub>e
                  </Typography>
                </Grid>
              </Grid>
            </Box>
