  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const tableData = [
        ...
        //   subType: '',
        //   subTypeData: {
        //     th: ['', 'Renewable Value', 'Adjusted Emission'],
        //     td: [
        //       {
        //         eType: 'Renewable Energy',
        //         // Use the renewable value from the form values
        //         value: values?.renewable,
        //         // Use adjustedEmission computed earlier
        //         // emissions: adjustedEmission > 0 ? adjustedEmission : '',
        //       },
        //     ],
        //   },
        // },
        ...
        <Card className="p-4 custom-inner-bg textborder">
          ...
          >
            ...
            >
              <Grid item xs={12} sm={4} md={4}>
                ...
                <Grid mt={2}>
                  ...
                  <TextField
                    ...
                    error={formik.touched.kwh && Boolean(formik.errors.kwh)}
                    helperText={formik.touched.kwh && formik.errors.kwh}
              ...
              <Grid item xs={12} sm={4} md={4}>
                <Typography variant="h4">Petrol (Generator)</Typography>
                <Grid mt={2}>
                  <FormLabel id="demo-row-radio-buttons-group-label" className="label-white">
                    Gallons
                  </FormLabel>
                  <TextField
                    ...
                    error={formik.touched.gallonsOne && Boolean(formik.errors.gallonsOne)}
                    helperText={formik.touched.gallonsOne && formik.errors.gallonsOne}
                    inputProps={{ style: { color: 'white' } }}
                  />
                </Grid>
                <Grid mt={2}>
              ...
              <Grid item xs={12} sm={4} md={4}>
                <Typography variant="h4">Diesel (Generator)</Typography>
                <Grid mt={2}>
                  <FormLabel id="demo-row-radio-buttons-group-label" className="label-white">
                    Gallons
                  </FormLabel>
                  <TextField
                    ...
                    error={formik.touched.gallonsTwo && Boolean(formik.errors.gallonsTwo)}
                    helperText={formik.touched.gallonsTwo && formik.errors.gallonsTwo}
                    inputProps={{ style: { color: 'white' } }}
                  />
                </Grid>
                <Grid mt={2}>
