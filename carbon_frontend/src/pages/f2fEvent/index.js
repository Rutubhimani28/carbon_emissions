    ...
    <div>
      ...
      <Container maxWidth className="custom-outer-bg tab-fixed mt-2">
        <Box className="tab-outer">
          ...
          >
            <Tab
              icon={<img src={AirTravel} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Air Travel"
              className="tab-text"
            />
            <Tab
              icon={<img src={Transportation} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Transportation"
              className="tab-text"
            />
            <Tab
              icon={<img src={Accommodation} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Hotel"
              className="tab-text"
            />
            <Tab
            ...
            />
            <Tab
              icon={<img src={Logistics} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Logistics"
              className="tab-text"
            />
            <Tab
              icon={<img src={production} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Event Agency"
              className="tab-text"
            />
            <Tab
              icon={<img src={Energy} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Energy"
              className="tab-text"
            />
            <Tab
              icon={<img src={digital} alt="" width={35} className="tabImgZoomIn tabImgWhite" />}
              label="Communications "
              className="tab-text"
            />
            <Tab
              icon={<img src={waste} alt="" width={35} color="red" className="tabImgZoomIn tabImgWhite" />}
              label="Waste"
              className="tab-text"
            />
            <Tab
